  ...
  <div>
    ...
    >
      ...
      <template v-slot:top="props">
        <q-input v-model="filter.description" :placeholder="$t('xshop_captions.l_name')"
    ...
    <standart-input-dialog v-model="formDialog" :model-id="bean.id" :on-submit="onSubmit"
      ...
      <div class="row">
        <q-input v-model="bean.description" :placeholder="$t('xshop_captions.l_name')"
                 :label="$t('xshop_captions.l_name')"
                 class="q-pa-md col-12" dense
                 lazy-rules :rules="[val => !!val || this.$t('system.field_is_required')]">
        </q-input>
